    ...
    <section class="item">
      <div class="item__pics pics">
        <div class="pics__wrapper">
          <img width="570" height="570" v-bind:src="image" :alt="product.title">
        </div>
      </div>
        ...
        <div class="item__form">
          <form class="form" action="#" method="POST" @submit.prevent="addToCart">
            ...
            <div class="item__row">
              ...
              <CartAmount v-bind:productAmount.sync="productAmount"/>
      ...
      <div class="item__desc">
        ...
        <div class="item__content">
          ...
          <p>
            ...
            дисплей диагональю 56 мм. На
            дисплей выводятся координаты и скорость, а также полученная со смартфона
            и синхронизированных датчиков
            ...
            что устройство не боится пыли, а также
